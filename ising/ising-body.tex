...
\davidsays{Explain the range of temperature compared, and why} Figure~\ref{fig:N32-cv-error} shows the maximum error in the heat capacity as a function of time for
...
(with an adequately small $\gamma^{\min}$) demonstrate excellent and robust convergence.
