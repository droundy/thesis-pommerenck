...
\jpsays{comment out the graphs we are not going to use i.e. the average entropy error.  Change Cv to cv in plots i.e. divide by 32 X 32 etc...}
...
\jpsays{edit here!}
We thank Klas Markstr\"{o}m for discussions regarding the exact computation of the partition function for the 2D Ising model.

Johannes Zierenberg for production run discussions


Martin Weigel for talking about EPA could cite earlier.
