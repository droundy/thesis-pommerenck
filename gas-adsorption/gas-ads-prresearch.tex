...
\title{An upper bound to gas storage and delivery via pressure-swing adsorption in
porous materials}
...
hydrogen~\cite{suh2011hydrogen,garcia2018benchmark, record-high-hydrogen-storage-2018} for vehicular storage at
...
\begin{figure}
    ...
    \caption{Deliverable capacity of hydrogen at room temperature as a function
    of the attractive Gibbs free energy $|\gst|$.  Experimental deliverable
    capacities for several porous materials (data from
    Ref.~\cite{garcia2018benchmark, record-high-hydrogen-storage-2018}) are shown along with the experimental
    values for $\gst$ at the empty and full pressures shown as $+$'s connected
    by a line.}
