...
The grand partition function of the control volume is:
\begin{multline}
...
\begin{figure}
    ...
    \caption{Cartoon illustrating the definition of $\gst$ and a
      ...
      temperature $T$. The quantity $\gst$ follows from \davidsays{the heat released?}.}
...
\begin{figure}
    ...
    \caption{Relationship between $\gst$ and the isosteric heat
      ...
      100~bar. \davidsays{Add citations.}}
...
\begin{figure}
    ...
    \caption{Four cases we consider. \davidsays{MAKE THIS FIGURE}}
