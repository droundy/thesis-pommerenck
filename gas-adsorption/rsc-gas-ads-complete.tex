...
\startreferees{Added last sentence to clarify why we cannot place a bound
  on the deliverable capacity when the temperature is changed.}
...
capacity.  \davidsays{As far as I can intuit, \emph{normally} the entropy
increases with temperature, and if that is the case then a uniform potential
will give the optimum deliverable capacity.  If we can prove that for a subset
of substrate interactions (e.g. when the substrate acts as an external potential
felt by the gas), the optimal potential is uniform then we could apply our model
to temperature-pressure swings.}
