...
gas. Our bound is unique in that it relies directly on experimentally measured
properties of the pure gas.
%
We conclude
that the goals set by the DOE for room-temperature natural gas and hydrogen
storage are just barely theoretically possible.
The goals are likely to be impossible for any real,
rigid porous material because of steric
repulsion, which must reduce the capacity below our upper
bound. Limitations
...
storage and alleviating many drawbacks of high-pressure or low-temperature
storage.
...
frameworks~\cite{}, no porous material has met these deliverable capacity targets.
