...
_colors = { 'SAD': 'tab:orange',
            ...
            'Exact': 'xkcd:black',
            'WL $(\gamma_{t}^{\min} = 10^{-4})$': 'r',
            'WL $(\gamma_{t}^{\min} = 10^{-6})$': 'midnightblue',
...
_legend_order = [
    ...
    'ising-wl-128',
    'ising-wl-32',
    'WL $(\gamma_{t}^{\min} = 10^{-4})$',
    'WL $(\gamma_{t}^{\min} = 10^{-6})$',
    'ising-wl-inv-t-128',
    'ising-wl-inv-t-32',
    'ising-samc-1e3-32',
    'ising-samc-1e4-32',
...
_legend_label = {
    ...
    'ising-wl-128': 'WL',
    'ising-wl-32': 'WL',
    'ising-wl-32-minGamma': 'WL $(\gamma_{t}^{\min} = 10^{-4})$',
    'ising-wl-128-minGamma':  'WL $(\gamma_{t}^{\min} = 10^{-4})$',
    'ising-wl-128-minGamma-1e6':  'WL $(\gamma_{t}^{\min} = 10^{-6})$',
