...
% (1) After examination, a major triump would be to determine $R_c$ theoretically particularly
% for large constraining radii i.e. extract volume independent heat capacity.
%
% (2) Examine how sad does on the magic number clusters? 38, 75, 104, and maybe some
% small ones 13, 19 or `easy' ones 135, 147?
%
