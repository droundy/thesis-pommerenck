...
python figs/parse-ising-out.py /home/jordan/sad-monte-carlo/ising-wl-128-minGamma-1e6-s1 128 ising-wl-128-minGamma-1e6
#cp data/gamma/ising/n128/ising-wl-128-minGamma-1e6.txt ../../../thesis-pommerenck/ising/data/gamma/n128/.
...
python3 scripts-python-make-data/ising-multi-heat-capacity.py --file_dir=../sad-monte-carlo/ --reference=/home/jordan/deft/papers/histogram/data/ising-128-T15-reference-lndos.dat --save_dir=ising/data/comparison/N128 --filename ising-wl-128-minGamma-1e6 --N=128 --Emin=31972 --Emax=0 --seed_avg=8
...
python3 scripts-python/ising-cv-save-csv.py --file_dir=../ising-cp-data/ --reference=../deft/papers/histogram/data/ising-32-reference-lndos.dat --save_dir=ising/data/heat-capacity --filename ising-sad-32 ising-wl-32 ising-wl-inv-t-32 ising-wl-32-minGamma --N=32 --Emin=2048 --Emax=0 --seed_avg=1
