...
Jordan K. Pommerenck, Tanner T. Simpson, Michael A. Perlin, David J. Roundy
...
\begin{figure}
  \includegraphics[width=\textwidth]{../square-well/N50-lndos-comparison.pdf}
  \caption[The entropy of a square-well fluid with 50 atoms and filling fraction
        0.3 as the green line.]{The entropy of a square-well fluid with 50 atoms and filling fraction
...
\begin{figure}
  \includegraphics[width=\textwidth]{../square-well/gamma-n256.pdf}
...
\begin{figure*}
  \includegraphics[width=0.5\textwidth]{../square-well/periodic-ww1_30-ff0_30-N50-gamma-and-entropy-error-default.pdf}%
\includegraphics[width=0.5\textwidth]{../square-well/periodic-ww1_30-ff0_30-N50-gamma-and-entropy-error-slow.pdf}
  \caption[(a) The average entropy error for each MC method for $N=50$,
               $\delta_0 = 0.05\sigma$, $\eta = 0.3$, and $T_{\min} = 1/3$
               as a function of number of iterations run.]{(a) The average entropy error for each MC method for $N=50$,
               $\delta_0 = 0.05\sigma$, $\eta = 0.3$, and $T_{\min} = 1/3$
...
\begin{figure}
\includegraphics[width=\textwidth]{../square-well/periodic-ww1_50-ff0_17-N256-entropy-error-default.pdf}
  \caption[The average entropy error for each MC method for $N=256$,
...
\begin{figure}
  \includegraphics[width=\textwidth]{../square-well/lj-cv.pdf}
  \caption[The heat capacity of the LJ31 cluster after $10^{12}$ moves
    as calculated with each method.]{The heat capacity of the LJ31 cluster after $10^{12}$ moves
...
\begin{figure}
  \includegraphics[width=\textwidth]{../square-well/lj-cv-error.pdf}
  \caption[The maximum error in the heat capacity of the LJ31 cluster
    in the temperature range 0.01~$\epsilon\le k_BT \le 0.05\epsilon$]{The maximum error in the heat capacity of the LJ31 cluster
